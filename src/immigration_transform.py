...
class ImmTransform:
    """
    This class performs transformation operations on the dataset and
    saves the results in parquet format in S3      
    """
    ...
    def transform_weather_data(self):
        ...
        #filter the dataset to fetch records with year '2013'
        ...
        #replace the names in Country column    
        ...
        #Read the look-up file containg the Country code and the Country name
        ...
        #Write the weather dataframe in S3 in parquet format
    ...
    def transform_demographics_data(self):
        ...
        #create a dataframe containing column values as columns
        ...
        #write the state dataframe to S3 in parquet format
    ...
    def transform_airport_data(self):
        ...
        #write the airport dataframe to S3 in parquet format
